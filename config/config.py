...
MONGO_DB_URI = getenv("MONGO_DB_URI",
                      "mongodb+srv://mrootx:RQvzwLBHpqRtjMNj@cluster.ivlkp.gcp.mongodb.net/winxdb?retryWrites=true&w=majority")
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "WinxMusicBot")
...
)  # Example:- https://t.me/TheWinx
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/WinxSupport
