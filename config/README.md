...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@mrootx](https://replit.com/@mrootx/GenerateStringSession) in Telegram.
...
### How to get these? [Read from here](https://engineering.atspotify.com/tag/deployment/)
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [replit](https://replit.com/@mrootx/GenerateStringSession)
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [replit](https://replit.com/@mrootx/GenerateStringSession)
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [replit](https://replit.com/@mrootx/GenerateStringSession)
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [replit](https://replit.com/@mrootx/GenerateStringSession)
