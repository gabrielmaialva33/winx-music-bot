...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("politicament")
                await self.one.join_chat("politicament")
                await self.one.join_chat("politicament")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("politicament")
                await self.two.join_chat("politicament")
                await self.two.join_chat("politicament")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("politicament")
                await self.three.join_chat("politicament")
                await self.three.join_chat("politicament")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("politicament")
                await self.four.join_chat("politicament")
                await self.four.join_chat("politicament")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("politicament")
                await self.five.join_chat("politicament")
                await self.five.join_chat("politicament")
            except:
                pass
